    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            if ($model->load($this->request->post())) {
                if ($model->save()) {
                    Yii::$app->session->setFlash('success', 'Método de Pagamento criado com sucesso.');
                    return $this->redirect(['view', 'id' => $model->id]);
                } else {
                    Yii::$app->session->setFlash('error', 'Ocorreu um erro ao criar o Método de Pagamento.');
                }
            }
        } else {
    ...
    public function actionUpdate($id)
    {
        ...
        if ($this->request->isPost && $model->load($this->request->post())) {
            if ($model->save()) {
                ...
                Yii::$app->session->setFlash('error', 'Ocorreu um erro ao atualizar o Método de Pagamento.');
            }
        }
