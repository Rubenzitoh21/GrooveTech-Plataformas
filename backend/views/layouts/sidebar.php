            ...
            echo \hail812\adminlte\widgets\Menu::widget([
                'items' => [
                    ...
                    ['label' => 'Perfil', 'header' => true],
                        ['label' => 'Perfil', 'icon' => 'fas fa-user', 'url' => ['/perfil/index'], 'visible' => ($userRole == 'admin' || $userRole == 'gestor')],
                    ['label' => 'Empresa', 'header' => true, 'visible' => ($userRole == 'admin')],
                        ['label' => 'Dados da Empresa', 'icon' => 'fas fa-user', 'url' => ['/empresas/index'], 'visible' => ($userRole == 'admin')],
                    ['label' => 'Gestão de Utilizadores', 'header' => true],
                        ['label' => 'Trabalhadores', 'icon' => 'users', 'url' => ['/user/index'], 'visible' => ($userRole == 'admin')],
