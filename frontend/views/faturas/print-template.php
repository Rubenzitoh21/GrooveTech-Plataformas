...
<!--<head>-->
<!--    <meta charset="UTF-8">-->
<!--    <title>Fatura #--><?php //= Html::encode($model->id) ?><!--</title>-->
<!--    <style>-->
<!--        body {-->
...
<!--<body>-->
<!--<div class="header">-->
<!--    <h1>Fatura #--><?php //= Html::encode($model->id) ?><!--</h1>-->
<!--    <p><strong>Emitida em:</strong> --><?php //= Yii::$app->formatter->asDate($model->data, 'php:d/m/Y') ?><!--</p>-->
<!--</div>-->
<!---->
<!--<div class="content">-->
<!--    <h3>Detalhes do Cliente</h3>-->
<!--    <p><strong>Nome:</strong> --><?php //= Html::encode($model->user->userProfile->primeironome . ' ' . $model->user->userProfile->apelido) ?><!--</p>-->
<!--    <p><strong>Endereço:</strong> --><?php //= Html::encode($model->user->userProfile->rua) ?><!--</p>-->
<!--    <p><strong>Email:</strong> --><?php //= Html::encode($model->user->email) ?><!--</p>-->
<!---->
...
<!--        </thead>-->
<!--        <tbody>-->
<!--        --><?php //foreach ($model->linhasFaturas as $index => $linha): ?>
<!--            <tr>-->
<!--                <td>--><?php //= $index + 1 ?><!--</td>-->
<!--                <td>--><?php //= Html::encode($linha->produtos->nome) ?><!--</td>-->
<!--                <td>--><?php //= Html::encode($linha->quantidade) ?><!--</td>-->
<!--                <td>--><?php //= number_format($linha->preco_venda, 2, ',', '.') ?><!-- €</td>-->
<!--                <td>--><?php //= number_format($linha->subtotal, 2, ',', '.') ?><!-- €</td>-->
<!--            </tr>-->
<!--        --><?php //endforeach; ?>
<!--        </tbody>-->
<!--        <tfoot>-->
...
<!--            <td>--><?php //= number_format($model->valortotal - $model->linhasFaturas[0]->valor_iva, 2, ',', '.') ?><!-- €</td>-->
<!--        </tr>-->
<!--        <tr>-->
<!--            <th colspan="4" style="text-align: right;">IVA</th>-->
<!--            <td>--><?php //= number_format($model->linhasFaturas[0]->valor_iva, 2, ',', '.') ?><!-- €</td>-->
<!--        </tr>-->
<!--        <tr>-->
<!--            <th colspan="4" style="text-align: right;">Total</th>-->
<!--            <td><strong>--><?php //= number_format($model->valortotal, 2, ',', '.') ?><!-- €</strong></td>-->
<!--        </tr>-->
<!--        </tfoot>-->
<!--    </table>-->
<!--</div>-->
<!---->
<!--<div class="footer">-->
<!--    <p><em>Obrigado pela sua compra!</em></p>-->
<!--</div>-->
<!--</body>-->
<!--</html>-->
<!DOCTYPE html>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="220" border="0" cellpadding="0" cellspacing="0" align="right" class="col">
                                        ...
                                        <tr>
                                            <td style="font-size: 21px; color: #36409f; letter-spacing: -1px; font-family: 'Open Sans', sans-serif; line-height: 1; vertical-align: top; text-align: right;">
                                                Invoice
                                            </td>
                                        </tr>
                                        <tr>
                ...
                <tr>
                    <td>
                        <table width="480" border="0" cellpadding="0" cellspacing="0" align="center" class="fullPadding">
                            ...
                            <tr>
                                <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #36409f;  line-height: 18px;  vertical-align: top; padding:10px 0;" class="article">
                            ...
                            <tr>
                                <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #36409f;  line-height: 18px;  vertical-align: top; padding:10px 0;" class="article">Beats RemoteTalk Cable</td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="220" border="0" cellpadding="0" cellspacing="0" align="right" class="col">
                                        ...
                                        <tr>
                                            <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b; line-height: 20px; vertical-align: top; ">
                                                Credit Card<br> Credit Card Type: Visa<br> Worldpay Transaction ID: <a href="#" style="color: #36409f; text-decoration:underline;">4185939336</a><br>
